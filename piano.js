! function (t, e) {
	...
	return function (t) {
		...
		var n, o;
		n = [i(6), i(5), i(7), i(1)], o = function (t, e, i, n) {
			var o = {
				"C#": "Db",
				"D#": "Eb",
				"F#": "Gb",
				...
				s = function (t, e, i) {
					this._canvas = document.createElement("canvas"), this._canvas.id = "PianoKeyboard", t.appendChild(this._canvas), this._context = this._canvas.getContext("2d"), this._container = t, this._startNote = e || "C4", this._endNote = i || "C6", this._notes = [], this._noteNames = {}, this._isMouseDown = !1, this._touchDragged = !1, this._contextStarted = !1, this._highlightedKeys = [], this._highlightColor = "#FFB729", this._container.addEventListener("resize", this._resize.bind(this)), this._container.addEventListener("mousedown", this._mouseDown.bind(this)), this._container.addEventListener("mousemove", this._mouseMove.bind(this)), this._container.addEventListener("mouseup", this._mouseUp.bind(this)), this._container.addEventListener("mouseleave", this._mouseLeave.bind(this)), this._container.addEventListener("touchstart", this._touchStart.bind(this)), this._container.addEventListener("touchend", this._touchEnd.bind(this)), this._container.addEventListener("touchmove", this._touchMove.bind(this)), this._makeKeys(), this._resize(), this.onkeydown = function () { }, this.onkeyup = function () { }, this.oncontextstart = function () { }
				};
			return s.prototype._resize = function () {
				...
				var t = this._context.canvas.width,
					...
					o = 2;
				this._context.lineWidth = o, this._context.clearRect(0, 0, t, e), this._context.strokeStyle = n.lightGrey;
				for (var s, h = i.getDistanceBetween(this._startNote, this._endNote), r = t / h, a = 0; a < this._keys.length; a++) s = this._keys[a], s.isSharp || s.draw(this._context, r, e);
				for (var u = 0; u < this._keys.length; u++) s = this._keys[u], s.isSharp && s.draw(this._context, r, e);
				return this._context.beginPath(), this._context.lineWidth = 2 * o, this._context.rect(0, 0, t, e), this._context.stroke(), this
				...
				for (var h, r, a = 0; a < this._keys.length; a++)
					...
					for (var u = 0; u < this._keys.length; u++)
						if (h = this._keys[u], !h.isSharp && h.testCollision(t, e)) {
							r = h;
							break
						} return r
			}, s.prototype._makeKeys = function () {
				this._notes = i.getNotes(this._startNote, this._endNote), this._keys = [];
				...
				this._isMouseDown = !0, e && (this._highlightedKeys.push(e), this.onkeydown(e.note))
			}, s.prototype._mouseUp = function (t) {
				t.preventDefault();
				var e = this._getCollision(t.offsetX, t.offsetY);
				this._isMouseDown = !1, e && (this._highlightedKeys.splice(this._highlightedKeys.indexOf(e), 1), this.onkeyup(e.note))
			}, s.prototype._mouseLeave = function (t) {
				t.preventDefault(), this._isMouseDown = !1;
				for (var e = 0; e < this._highlightedKeys.length; e++) this.onkeyup(this._highlightedKeys[e].note);
				...
				if (this._isMouseDown) {
					...
					if (-1 === this._highlightedKeys.indexOf(e)) {
						for (var i = 0; i < this._highlightedKeys.length; i++) this.onkeyup(this._highlightedKeys[i].note);
						this._highlightedKeys = [], e && (this._highlightedKeys.push(e), this.onkeydown(e.note))
					}
				}
			}, s.prototype._touchStart = function (t) {
				t.preventDefault();
				for (var e = this._container.getBoundingClientRect(), i = t.changedTouches, n = 0; n < i.length; n++) {
					var o = i[n],
				...
				for (var e = this._container.getBoundingClientRect(), i = t.changedTouches, n = 0; n < i.length; n++) {
					var o = i[n],
						s = this._getCollision(o.clientX - e.left, o.clientY - e.top);
					s && (this._highlightedKeys.splice(this._highlightedKeys.indexOf(s), 1), this.onkeyup(s.note))
				}
				...
				for (var e = this._container.getBoundingClientRect(), i = t.changedTouches, n = 0; n < i.length; n++) {
					...
					if (-1 === this._highlightedKeys.indexOf(s)) {
						for (var h = 0; h < this._highlightedKeys.length; h++) this.onkeyup(this._highlightedKeys[h].note);
						this._highlightedKeys = [], s && (this._highlightedKeys.push(s), this.onkeydown(s.note))
					}
				}
				...
				else this._noteNames.hasOwnProperty(t) && this._noteNames[t].highlight(this._highlightColor);
				this.draw()
				...
				if (Array.isArray(t))
					...
					s.isSharp ? this._noteNames[t].highlight(i || n.lightGrey) : this._noteNames[t].highlight(e || "black")
				}
				this.draw()
			}, s.prototype.keyUp = function (t) {
				if (Array.isArray(t))
					for (var e = 0; e < t.length; e++) this.keyUp(t[e]);
				else this._noteNames.hasOwnProperty(t) && this._noteNames[t].unhighlight();
				this.draw()
			}, s.prototype.unselectAll = function () {
				for (var t = 0; t < this._keys.length; t++) this._keys[t].unhighlight();
				this.draw()
			}, s
		...
		t.exports = function () {
			...
			return t.toString = function () {
				...
				for (o = 0; o < e.length; o++) {
					var h = e[o];
					"number" == typeof h[0] && n[h[0]] || (i && !h[2] ? h[2] = i : i && (h[2] = "(" + h[2] + ") and (" + i + ")"), t.push(h))
				}
			}, t
		}
	}, function (t, e, i) {
		function n(t, e) {
			for (var i = 0; i < t.length; i++) {
				...
				if (o) {
					...
					for (var h = [], s = 0; s < n.parts.length; s++) h.push(r(n.parts[s], e));
					l[n.id] = {
						id: n.id,
						refs: 1,
						parts: h
		...
		function o(t) {
			for (var e = [], i = {}, n = 0; n < t.length; n++) {
				...
				i[s] ? i[s].parts.push(u) : e.push(i[s] = {
					id: s,
					parts: [u]
				})
			}
		...
		function r(t, e) {
			...
			if (e.singleton) {
				var r = _++;
				i = g || (g = s()), n = a.bind(null, i, r, !1), o = a.bind(null, i, r, !0)
			} else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = h(), n = c.bind(null, i), o = function () {
				i.parentNode.removeChild(i), i.href && URL.revokeObjectURL(i.href)
			}) : (i = s(), n = u.bind(null, i), o = function () {
		...
		function a(t, e, i, n) {
			...
			if (t.styleSheet) t.styleSheet.cssText = v(e, o);
				...
				var s = document.createTextNode(o),
					h = t.childNodes;
				h[e] && t.removeChild(h[e]), h.length ? t.insertBefore(s, h[e]) : t.appendChild(s)
			}
		}
		...
		n = [i(1)], o = function (t) {
			"use strict";
			var e = function (t, e) {
				this.note = t, this._offset = e, this.isSharp = -1 !== this.note.indexOf("#"), this._isHighlighted = !1, this._highlightColor = "", this.setHighlightColor("rainbow"), this._computeBoundingBox()
			};
			return e.prototype._computeBoundingBox = function () {
				...
				return i[0] <= t && i[0] + i[2] >= t && i[1] <= e && i[3] >= e ? !0 : void 0
			}, e.prototype.draw = function (e, i, n) {
				e.beginPath(), this._isHighlighted ? e.fillStyle = this._highlightColor : e.fillStyle = this.isSharp ? t.charcoal : "white";
				var o = this._computeBoundingBox();
				return o[0] = Math.round(i * o[0]), o[2] = Math.round(i * o[2]), o[1] = Math.round(n * o[1]), o[3] = Math.round(n * o[3]), e.rect.apply(e, o), e.fill(), this.isSharp || this._isHighlighted || e.stroke(), this
			}, e
		}.apply(e, n), !(void 0 !== o && (t.exports = o))
	}, function (t, e, i) {
		var n;
